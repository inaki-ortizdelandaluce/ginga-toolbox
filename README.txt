![ginga-toolbox-logo.png](https://bitbucket.org/repo/ynaqke/images/1269494490-ginga-toolbox-logo.png) 
...
1. Go to the source code local repository folder
> cd ~/ginga-toolbox.git

2. Fetch latest source code from server
> git pull
...
4. Install the software (X.Y version)
...
The software pre-requisites are the following:

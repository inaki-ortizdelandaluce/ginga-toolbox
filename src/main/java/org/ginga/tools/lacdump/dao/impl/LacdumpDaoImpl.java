...
public class LacdumpDaoImpl implements LacdumpDao {
	...
	public final SimpleDateFormat dateFmt = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");

	/*
	 * (non-Javadoc)
	 * 
	 * @see org.ginga.tools.lacdump.dao.LacDumpDao#save(org.ginga.tools.lacdump.
	 * LACDumpEntity)
	 */
	@Override
	...
	public LacdumpSfEntity findById(long id) throws LacdumpDaoException {
		...
		try {
			HibernateUtil.beginTransaction();
			Session hibernateSession = HibernateUtil.getSession();
			entity = (LacdumpSfEntity) hibernateSession.get(
					LacdumpSfEntity.class, id);
			HibernateUtil.commitTransaction();
		} catch (Exception e) {
			throw new LacdumpDaoException(e);
		} finally {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ginga.tools.lacdump.dao.LACDumpDao#saveList(lava.util.List<
	 * LacDumpSfEntity>)
	 */
	@Override
	public void saveList(List<LacdumpSfEntity> entityList)
		...
		try {
			...
			for (LacdumpSfEntity entity : entityList) {
				...
				log.debug(entity.getSuperFrame() + ":"
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.ginga.tools.lacdump.dao.LacDumpDao#findSfList(java.lang.String,
	 * java.lang.String, java.lang.String, java.util.Date, java.util.Date,
	 * double, double)
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<LacdumpSfEntity> findSfList(String bitRate, String mode,
			String target, String startTime, String endTime, double elevation,
	 ...
	 * 
	 * @see
	 * org.ginga.tools.lacdump.dao.LacDumpDao#findSfList(org.ginga.tools.lacdump
	 * .LacDumpQuery)
	 */
	@SuppressWarnings("unchecked")
	@Override

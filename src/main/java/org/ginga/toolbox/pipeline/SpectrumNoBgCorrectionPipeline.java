...
public class SpectrumNoBgCorrectionPipeline {

    private static final Logger LOGGER = Logger.getLogger(SpectrumNoBgCorrectionPipeline.class);
    ...
    public SpectrumNoBgCorrectionPipeline() {
        ...
        this.pipeline = new Pipeline<LacModeTargetObservation, File>(this.modeFilter, this.queryBuilder, this.lacqrdfitsInputBuilder,
                this.lacqrdfits, this.lac2xspec);
    }

    public void run(List<LacModeTargetObservation> obsList) {
        LOGGER.debug("Entering into SpectrumNoBgCorrectionPipeline.run...");

...
import org.ginga.toolbox.lacdump.LacdumpDatabaseIngestor;

public class LacdumpDatabaseIngestorCmd {

    public static final Logger log = Logger.getLogger(LacdumpDatabaseIngestorCmd.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            // write target list
            LacdumpDatabaseIngestor ingestor = new LacdumpDatabaseIngestor();
    ...
    private static Options getOptions() {
        ...
        Option fileOption = OptionBuilder.withArgName("file path").withLongOpt("directory")
                .withDescription("LACDUMP root directory").hasArg().create("d");

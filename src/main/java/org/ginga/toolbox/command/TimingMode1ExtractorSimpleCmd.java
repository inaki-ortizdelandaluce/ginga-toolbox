...
public class TimingMode1ExtractorSimpleCmd {

    protected final static String DATE_FORMAT_PATTERN = TimeUtil.DATE_FORMAT_INPUT.toPattern();
    private final static Logger log = Logger.getLogger(TimingMode1ExtractorSimpleCmd.class);
    ...
    private static void printHelp() {
        ...
        helpFormatter.printHelp("extract_timing_mode1_simple.sh", getOptions());
    }
